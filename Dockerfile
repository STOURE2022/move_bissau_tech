# Dockerfile pour Railway — backend Django + frontend + admin MoveBissau

# === Étape 1 : Build du frontend passager React ===
...
# === Étape 2 : Build du dashboard admin React ===
...
# === Étape 3 : Backend Django + fichiers frontend + admin ===
...
# Copier les builds frontend
COPY --from=frontend-build /frontend/dist /app/frontend_dist
COPY --from=admin-build /admin/dist /app/admin_dist
