...
/**
 * Carte de parrainage — affichée dans le profil.
 * Montre le code parrain, permet de le partager, et affiche les stats.
 */
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-white/70 text-xs">Gagnez 500 F CFA par filleul</p>
        </div>
      </div>
      ...
      {stats && (
        <div className="flex gap-3 mb-4">
          <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
            ...
            <p className="text-[10px] text-white/60">Invités</p>
          </div>
          <div className="flex-1 bg-white/10 rounded-xl px-3 py-2 text-center">
            <p className="text-lg font-bold">{stats.total_bonus} F</p>
            <p className="text-[10px] text-white/60">Bonus gagné</p>
          </div>
        </div>
      )}
