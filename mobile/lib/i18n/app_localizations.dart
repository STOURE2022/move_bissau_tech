...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'fr': {
      ...
      'chat_empty': 'Envoyez un message rapide ci-dessous',
      'chat_where_are_you': 'Où êtes-vous ?',
      'chat_im_coming': 'J\'arrive',
      'chat_im_here': 'Je suis là',
      'chat_at_pickup': 'Je suis au point de départ',
      'chat_wait_2min': 'Attendez-moi 2 minutes',
      'chat_traffic': 'Il y a des embouteillages',
      'chat_call_me': 'Appelez-moi s\'il vous plaît',
      'chat_ok': 'OK 👍',
    ...
    'pt': {
      ...
      'chat_empty': 'Envie uma mensagem rápida abaixo',
      'chat_where_are_you': 'Onde está?',
      'chat_im_coming': 'Estou a chegar',
      'chat_im_here': 'Cheguei',
      'chat_at_pickup': 'Estou no ponto de partida',
      'chat_wait_2min': 'Espere 2 minutos',
      'chat_traffic': 'Há trânsito',
      'chat_call_me': 'Ligue-me por favor',
      'chat_ok': 'OK 👍',
    ...
    'gcr': {
      ...
      // Chat di viaji
      'chat_title': 'Mensajen',
      'chat_placeholder': 'Skirbi mensajen…',
      'chat_empty': 'Manda un mensajen rapidu la baxu',
      'chat_where_are_you': 'Bu sta undi?',
      'chat_im_coming': 'N na txiga',
      'chat_im_here': 'N txiga',
      'chat_at_pickup': 'N sta na kau di partida',
      'chat_wait_2min': 'Spera n 2 minutu',
      'chat_traffic': 'Strada sta cheiu',
      'chat_call_me': 'Toka n pur favor',
      'chat_ok': 'OK 👍',
